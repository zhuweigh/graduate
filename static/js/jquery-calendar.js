...
var popUpCal = {
    ...
    showCalendar: function() {
        ...
        if (this.timeSeparators.length > 1) {
            timeSelect += '<div id="calendar_time"><div class="select" style="width:37px;margin-left:55px;float:left;"><select id="calendar_hour" style="width:40px">';
            ...
            timeSelect += '</select></div><div class="select" style="float:left;width:10px;">' + this.timeSeparators[1] + '</div> <div class="select" style="float:left;width:37px"><select id="calendar_minute" style="width:40px">';
            for (var a = 0; a <= 59; a++) {
        ...
        if (!this.changeMonth) {
            ...
            html += '<div class="select" style="width:60px; margin-left:35px;float:left;"><select id="calendar_newMonth" style="width:60px">';
        ...
        if (!this.changeYear) {
            ...
            html += '<div class="select" style="width:49px;float:left;"><select id="calendar_newYear" style="width:52px;margin-left:7px;height:21px;">';
